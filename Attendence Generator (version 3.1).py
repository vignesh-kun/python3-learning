...
print('')
print('hello, user !!!')
print('Welcome to attendence taker_version 3.3.1 :)')
...
abs_str_list = []#final str result list
list = []
...
#preparing abs_list:
for y in range (46):
	if pres_list[z+1] not in class_str_list:
		abs_str_list.append(pres_list[z+1])
		z=z+1
...
print(abs_list)
print("")
print("the wrong entered presentees:")
print(abs_str_list)
print('')
print('')
input('press enter key to continue...')
